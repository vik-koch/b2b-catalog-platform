...
| 15<br>`v1.13.0` | Storefront presentation: links elsewhere, category marks, the main page, richer search, the conditions page, subtree counts, sets | [FR-NAV-07](requirements.md#fr-nav-07),<br>[FR-CAT-07](requirements.md#fr-cat-07)/[08](requirements.md#fr-cat-08)/[09](requirements.md#fr-cat-09)/[10](requirements.md#fr-cat-10),<br>[FR-SEARCH-06](requirements.md#fr-search-06)/[07](requirements.md#fr-search-07),<br>[FR-ADM-19](requirements.md#fr-adm-19),<br>[FR-ATTR-12](requirements.md#fr-attr-12) | [FR-NAV-03](requirements.md#fr-nav-03),<br>[FR-CAT-01](requirements.md#fr-cat-01)/[02](requirements.md#fr-cat-02)/[03](requirements.md#fr-cat-03),<br>[FR-SEARCH-02](requirements.md#fr-search-02),<br>[FR-ADM-05](requirements.md#fr-adm-05),<br>[FR-ATTR-02](requirements.md#fr-attr-02) |
...
- **The catalogue index becomes a listing** ([FR-CAT-02](requirements.md#fr-cat-02)/[03](requirements.md#fr-cat-03)
  amended, [FR-ATTR-12](requirements.md#fr-attr-12)) (2026-09-26). Once the main page had a
  featured row, the index at `/catalog` was the main page without it. It is now the listing
  one level above any category: every product, with the top-level categories as its chips
  where a category shows its subcategories, and a breadcrumb of one, so its heading sits where a
  category's does. It does not carry the main page's index with
  subcategory names, which with a dozen top-level groups is a screen of navigation before the
  first product. Its filters are a **list of their own** rather than the registry. The whole
  catalogue carries every attribute there is, and what is worth filtering across categories — a
  brand — is a short, deliberate choice, so nothing is offered until it is chosen. It is kept
  apart from the category lists rather than stored as a category with no category, because it is
  not an ancestor: under [FR-ATTR-11](requirements.md#fr-attr-11)'s inheritance every category
  without a list would otherwise have followed it. Search keeps the registry for now. It spans
  categories too, but moving it to this list would change what every search offers, and that is
  a separate decision. Product pages keep linking to their own category.
