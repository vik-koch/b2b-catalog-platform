  ...
  orderStatusChanged: {
    ...
    statuses: {
      ...
      approved: {
        ...
        body: 'We have confirmed your order as you sent it. We will let you know as soon as it is ready.',
      },
      adjusted: {
        heading: 'Your order is confirmed, with the changes we agreed',
        body: 'We have confirmed your order with the changes we discussed. Its contents and total are below — please tell us if anything reads differently from what we agreed.',
      },
      readyDelivery: {
