    ...
    areas: {
      ...
      customers: {
        failed: {
          ...
          heading: 'An automatic customer update failed',
          body: 'Your customer accounts are unchanged and everybody who could sign in still can.',
          action: 'Open the run',
        },
        recovered: {
          subject: 'Customer updates are working again',
          preheader: 'The automatic customer update went through.',
          heading: 'Customer updates are working again',
          body: 'The connection to your system is delivering again.',
          action: 'Open the run',
        },
        waiting: {
          ...
          heading: 'A customer update is waiting for you',
          body: 'It has not been applied. Apply it or discard it.',
          action: 'Review the update',
        },
      },
