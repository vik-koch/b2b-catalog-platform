...
@Component({
  ...
  template: `
    ...
    <div class="max-w-3xl">
      ...
      <!-- One stack with one gap, rather than a margin repeated on every
           section: the space between two cards is a property of the list
           they are in, not of each card. -->
