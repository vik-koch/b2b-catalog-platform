 ...
 */
const base =
  'block rounded-md border border-border-strong bg-white focus:border-primary focus:outline-offset-0 focus:outline-primary disabled:cursor-not-allowed disabled:bg-stone-100';
