...
export const ORDER_PROBES = {
  ...
  waitingOnShop: {
    ...
    meaning:
      'Whether the order is in the queue the staff panel counts and its marker links to — orders nobody has answered. 🟡 means the next move is the shop’s.',
  },
  waitingOnCustomer: {
    label: 'Waiting for the customer',
    meaning:
      'Whether the customer’s own panel is flagging this order — money owed, or a collection ready to be picked up. 🟡 is the marker they see on signing in. `n/a` for a guest, who has no panel and hears from the shop only by mail.',
  },
  mail: {
